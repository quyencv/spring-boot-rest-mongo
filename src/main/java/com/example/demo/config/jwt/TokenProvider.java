...
public class TokenProvider {
    ...
    private static final String JWT_SECRET = "bm90aWh1YkAxMjM=";
    ...
    public TokenProvider(SecurityMetersService securityMetersService) {
        ...
        this.tokenValidityInMilliseconds = 1 * TimeUnit.DAYS.toMillis(1);
        this.tokenValidityInMillisecondsForRememberMe = 10 * TimeUnit.DAYS.toMillis(1);
